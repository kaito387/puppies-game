...
import { isDogNameValid, sanitizeDogName, getAssignedCount, getPopulationCount } from '@/engine/dogs'
...
function DogCard(props: {
    ...
    console.log('狗狗：', props.dog.name, '颜色：', props.dog.color);
    ...
    return (
        <Card className="border-dashed" style={{ borderColor: `${dog.color}60` }}>
            <CardContent className="space-y-3 pt-5">
                <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="space-y-2">
                        <div className="flex flex-wrap items-center gap-2">
                            <h3 className="text-base font-semibold" style={{ color: dog.color }}>{dog.name}</h3>
                            ...
                            return (
                                <div key={job.id} className="rounded-md border p-3">
                                    ...
                                    <div className="mt-3 flex items-center gap-1.5">
                                        <Button variant="outline" size="xs" disabled={!canDecrease} onClick={() => setWithDelta(job.id, assigned, -10)}>
                                            -10
                                        </Button>
                                        ...
                                        <Button variant="outline" size="xs" disabled={!canIncrease} onClick={() => setWithDelta(job.id, assigned, 10)}>
                                            +10
                                        </Button>
                                    </div>
                                </div>
